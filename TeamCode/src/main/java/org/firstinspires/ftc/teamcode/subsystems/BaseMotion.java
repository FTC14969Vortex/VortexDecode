...
public class BaseMotion {
    ...
    public void setMotorPowers(double leftX, double leftY, double rightX) {
        ...
        double maxLinearVelocity = 30.0; // inches/sec
        double maxAngularVelocity = 180.0; // degrees/sec
        
        double vx = leftX * maxLinearVelocity;
        double vy = -leftY * maxLinearVelocity; // Invert Y for intuitive control
