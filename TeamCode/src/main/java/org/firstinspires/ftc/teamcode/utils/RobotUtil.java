...
public class RobotUtil {
    ...
    public static void telemetryFlyWheelVelocity(FlyWheel flyWheel, double flyWheelPower, DistanceSensor frontDistanceSensor, int runForMS, Telemetry telemetry) {
        ...
        telemetry.addData("Power - " + flyWheelPower, "Distance - " + RobotUtil.getDistance(frontDistanceSensor, telemetry));
        long startTime = System.currentTimeMillis();
    ...
    public static void prepareFlyWheelToIntake(FlyWheel flyWheel, Kicker kicker, Intake intake, Flipper flipper, Telemetry telemetry) {
        ...
        RobotUtil.waitForFlyWheelStopVelocity(flyWheel, 200, 3000, telemetry);
    ...
    public static FlyWheelSpinUpResult prepareForShooting(FlyWheel flyWheel, Kicker kicker, Flipper flipper, Intake intake, Double distanceInInchFromAprilTag, Telemetry telemetry) {
        Integer requiredFlyWheelVelocity = RobotUtil.getRequiredFlyWheelVelocity(distanceInInchFromAprilTag);
        FlyWheelSpinUpResult result = RobotUtil.waitForFlyWheelShootingVelocity(flyWheel, requiredFlyWheelVelocity, 3000, telemetry);
    ...
    public static void shoot(FlyWheel flyWheel, Kicker kicker, Flipper flipper, Intake intake, Double robotDistanceFromAprilTag, AprilTagProcessor aprilTag, String aprilTagName, Telemetry telemetry) {
        ...
        for (int shotNumber = 0; shotNumber < NUM_SHOTS; shotNumber++) {
            ...
            // Calculate flipper angle for this shot (120 degrees, 150 degrees, 180 degrees, 210 degrees)
...
//                Double odoPosY = odo.getPosY(DistanceUnit.INCH);
                ...
                */
                ...
                while (odo.getPosY(DistanceUnit.INCH) < targetPosition && timer.milliseconds() < TIMEOUT_MS) {
                    ...
                    // Handle wraparound (e.g., target 1 degrees, current 359 degrees)
            ...
            case TURN_LEFT:
                ...
                while (currentAngle < targetAngle && timer.milliseconds() < TIMEOUT_MS) {
                    ...
                    if (Math.abs(errorAngle) < ERROR_RANGE_DEGREE) {
                        RobotUtil.setMotorPower(leftFront, leftBack, rightFront, rightBack, 0, 0, 0);
                        break;
                    }
                }
                break;
...
//        telemetry.update();
    ...
    public static AlignmentResult autoAlignWithAprilTag(
        ...
        final double P_TURN_GAIN = 0.02;             // Proportional gain for bearing control (0.02 = 0.6 power at 30 degrees error)
        ...
        // Strategy: Scan +/-90 degrees while moving FORWARD to increase viewing distance
