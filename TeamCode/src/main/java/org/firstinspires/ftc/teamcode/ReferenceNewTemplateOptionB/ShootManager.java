...
public ShooterController(FlyWheel flyWheel,
                         Kicker kicker,
                         Flipper flipper,
                         Intake intake,
                         Telemetry telemetry) {
 ...
 */
public void startShootCycle(double distanceInch, double timeoutSec) {
    ...
    // prep mechanisms for shooting (no alignment here)
