                ...
                switch (currentNearAutoStage) {
                    ...
                    case SHOOT:
                       // alignmentResult = RobotUtil.autoAlignWithAprilTag(this, aprilTag, AprilTagProcessor.BLUE_APRIL_TAG, chassis, telemetry);
                        ...
                        RobotUtil.shoot(flyWheel, kicker, flipper, intake,robotDistanceFromAprilTag, aprilTag, AprilTagProcessor.BLUE_APRIL_TAG, telemetry);
                    ...
                    case SHOOT_AGAIN:
                        alignmentResult = RobotUtil.autoAlignWithAprilTag(this, aprilTag, AprilTagProcessor.BLUE_APRIL_TAG, chassis, telemetry);
                        RobotUtil.shoot(flyWheel, kicker, flipper, intake, alignmentResult.distance, aprilTag, AprilTagProcessor.BLUE_APRIL_TAG, telemetry);
