...
@Autonomous(name = "Square Bezier Line with Tangential Heading 0.1", group = "PedroPathTestCases")
public class SquareBezierLineWithTangentialHeading extends OpMode {
    ...
    public void buildPaths() {
        int sideLengthInInches = 36;
        squarePath = follower.pathBuilder()
                // Side 1: (0,0) to (24,0)
                .addPath(new BezierLine(new Pose(0, 0, 0), new Pose(sideLengthInInches, 0, 0)))
                .setTangentHeadingInterpolation()

                // Side 2: (24,0) to (24,24)
                .addPath(new BezierLine(new Pose(sideLengthInInches, 0, 0), new Pose(sideLengthInInches, sideLengthInInches, 0)))
                .setTangentHeadingInterpolation()

                // Side 3: (24,24) to (0,24)
                .addPath(new BezierLine(new Pose(sideLengthInInches, sideLengthInInches, 0), new Pose(0, sideLengthInInches, 0)))
                .setTangentHeadingInterpolation()

                // Side 4: (0,24) back to (0,0)
                .addPath(new BezierLine(new Pose(0, sideLengthInInches, 0), new Pose(0, 0, 0)))
                .setTangentHeadingInterpolation()
