 ...
 */
@Autonomous(name = "Red Auto Far 0.03", group = "Debug")
public class RedAutoFar extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        try {
            ...
            baseMotion.timeMotion(BaseMotion.Direction.LEFT, 12, 1);
   ...
   //         telemetryCurrentPose("After Second Intake and Shoot");
    ...
    private void intakeAndShoot() throws InterruptedException {
        ...
        robotOperations.shoot(1600, true, true); // use cameraservo for align + distance
    }
