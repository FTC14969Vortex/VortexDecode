...
public class MotionConfig {
    ...
    public static final double POSITION_DEADBAND = 0.25;
    
    /** Dead-band for heading control - no rotation within this range (degrees) */
    public static final double HEADING_DEADBAND = 1;
    ...
    public static final double POSITION_FEEDFORWARD_GAIN = 0.8;  // TODO: CALIBRATE THIS VALUE!
